...
type MetricSpec struct {
	...
	// (for images, hits-per-second on an Ingress object).
	// +optional
	Object *ObjectMetricSource `json:"object,omitempty" protobuf:"bytes,2,opt,name=object"`
	// pods refers to a metric describing each pod in the current scale target
	// (for images, transactions-processed-per-second).  The values will be
	...
	// (for images length of queue in cloud messaging service, or
...
var (
	...
	// target (for images, transactions-processed-per-second).  The values
...
// kubernetes object (for images, hits-per-second on an Ingress object).
...
// the current scale target (for images, transactions-processed-per-second).
...
// any Kubernetes object (for images length of queue in cloud
...
type MetricTarget struct {
	...
	// TODO 注释
	// +optional
	ScaleType MetricTargetScaleType `json:"scaleType" protobuf:"bytes,5,name=scaleType"`
}
...
// MetricTargetScaleType specifies the type of scale up or down, and should be either
// "ScaleUp", "ScaleDown", or "Both"(Default Both)
type MetricTargetScaleType string

var (
	ScaleUpMetricsTargetType   MetricTargetScaleType = "ScaleUp"
	ScaleDownMetricsTargetType MetricTargetScaleType = "ScaleDown"
)
